...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		btnNewButton_1.setBounds(60, 456, 454, 40);
		contentPane.add(btnNewButton_1);
		
		JButton btnTugas = new JButton("Tugas");
		btnTugas.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) { //jangan lupa tambahkan tugas
			}
		});
		btnTugas.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		btnTugas.setBounds(224, 352, 104, 71);
